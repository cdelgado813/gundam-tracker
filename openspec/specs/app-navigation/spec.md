...
## Purpose
Cómo se navega por la app: memoria de scroll al volver, botones para saltar al principio/final de una lista larga, y reinicio de sección al repulsar su pestaña activa.
## Requirements
