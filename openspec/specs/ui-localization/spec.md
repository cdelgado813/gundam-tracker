...
## Purpose
La interfaz en español, inglés y catalán con diccionario tipado (falta una clave en un idioma = falla la compilación), y el idioma de interfaz separado del idioma de cada copia de carta.
## Requirements
