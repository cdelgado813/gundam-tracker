...
## Purpose
La pantalla de bienvenida que ve quien abre la app por primera vez, y su contenido compartido con `/about` — sin cambiar de sitio, dominio ni PWA respecto al resto de la app.
## Requirements
